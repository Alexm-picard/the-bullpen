...
export const ROADMAP_PARA: string =
  "The ML systems wrapper is operating: a calibrated batted-ball outcome model serves as the registry champion, the pitch pre- and post-pitch heads sit in shadow beside their logistic-regression baseline, live MLB ingest runs each game day, and the nightly drift + calibration jobs are wired to the live prediction log. The rolling-origin CV harness, isotonic calibration (pre-head ECE 0.0036), and ONNX export with 1e-6 Python-parity underpin every registered model. The 2026 season is the operational window the build was aimed at: a real drift postmortem against data the system is capturing now. Phase 6 hiring-readiness work (README polish, the drift postmortem, an upstream OSS PR) remains ahead.";

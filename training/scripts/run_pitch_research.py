...
def main() -> None:
    ...
    print(f"  acc={m.accuracy:.4f}  top2={m.top2_accuracy:.4f}  done in {v2_time:.1f}s")
    ...
    all_results.append(m)
    print(f"  acc={m.accuracy:.4f}  top2={m.top2_accuracy:.4f}  done in {v2b_time:.1f}s")
    ...
    all_results.append(m)
    print(f"  acc={m.accuracy:.4f}  top2={m.top2_accuracy:.4f}  done in {v2_time + hy_time:.1f}s")
    ...
    all_results.append(m)
    print(f"  acc={m.accuracy:.4f}  top2={m.top2_accuracy:.4f}  done in {v2b_time + hyb_time:.1f}s")
